...
<body>
  ...
  ?>
  <h1 class="text-center fw-bold m-0 pb-4">KPI <span class="fst-italic">LOCK & UNLOCK</span></h1>
      ...
      <div>
        ...
        <div class="d-flex flex-wrap justify-content-end" style="gap: 1em;">
          <button type="button" id="btnResetDgUtama" class="btn rounded btn-sm btn-reset">
            <span class="d-inline-block ps-1">Reset KPI</span>
          </button>
        ...
        <table id="dgUtama" class="table table-hover table-striped table-bordered w-100 table-nowrap">
          <thead class="table-dark">
            <tr id="trHeaderUtama">
              ...
              <th class="align-middle text-center" colspan="12">Target Bulan</th>
            </tr>
            <tr id="monthTarget">
            </tr>
          </thead>
