...
?>
  <title>KPI DIVISI KORPORAT</title>
...
<body>
  ...
  ?>
  <h1 class="text-center fw-bold m-0 pb-4 pt-2">KPI DIVISI KORPORAT</h1>
      ...
      <div>
        <table class="mb-3">
          <tbody>
            ...
            <tr>
              <td class="pt-2 pe-3"><label for="dgUtamaDivisionCorpsInput" class="form-label mb-0 fs-5">Departemen <span class="fw-bold text-danger">*</span></label></td>
              <td class="pt-2 pe-3">
                <select class="form-select form-select-sm" name="dgUtamaDivisionCorpsInput" id="dgUtamaDivisionCorpsInput" data-placeholder="Masukan Departemen..." style="width: 310px;"></select>
              </td>
              <td class="pt-2">
    ...
    <div class="d-block overflow-auto w-100 position-relative rounded-top">
      <table id="dgUtama" class="table table-hover table-striped table-bordered w-100 table-nowrap">
        <thead class="table-dark">
          <tr>
            <th class="align-middle text-center" colspan="28" id="dgUtamaYear">KPI</th>
          </tr>
          <tr>
          ...
          <div class="d-flex justify-content-start align-items-start" style="gap: 1.5rem;">
            <div>
              <table class="table table-borderless w-100 nowrap table-information">
                <tbody>
                  <tr>
                    <th class="ps-0" style="white-space: nowrap;">Tahun KPI<br><small class="text-danger fw-bold">(unik - KPI)</small></th>
                    <th class="px-1">:</th>
                    <td id="modalEditorTahunKPI"></td>
                  </tr>
                  <tr>
                    <th class="ps-0" style="white-space: nowrap;">Departemen<br><small class="text-danger fw-bold">(unik - KPI)</small></th>
                    <th class="px-1">:</th>
                    <td id="modalEditorDivisionCorpsKPI"></td>
                  </tr>
                </tbody>
              </table>
            </div>
