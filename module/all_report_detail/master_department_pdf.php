...
if (!empty($items)) {
	foreach ($items as $key => $value) {
		...
		<tr>
			...
			<td valign='middle' style='width:90px;'>$id</td>
			<td valign='middle' style='width:130px;'>$dep</td>
			<td valign='middle' style='width:70px;'>$alias</td>
			<td valign='middle' style='width:70px;'>$id_det</td>
			<td valign='middle' style='width:130px;'>$sec</td>
