...
$db->konek_sita_db();
// print_r($_SESSION);
$sql_w = "SELECT a.* from satuan_master a
...
$content .= "
	...
	<h3 align='center'>Master Satuan</h3>
		<table align='center' style='font-size:10px;'>
			<tr>
				<th valign='middle' align='center' style='height:30px;'>No.</th>
				<th valign='middle' align='center' style='height:30px;'>Kode Satuan</th>
				<th valign='middle' align='center' style='height:30px;'>Nama Satuan</th>
...
$html2pdf->Output('Master Satuan.pdf');
// echo $content;
?>
