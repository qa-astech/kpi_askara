...
// print_r($where);
// die();
$sql = "SELECT a.* from perspective a
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A4', 'Master Perspektif')
            ->setCellValue('A5', 'No')
            ->setCellValue('B5', 'Kode Perspektif')
            ->setCellValue('C5', 'Nama Perspektif')
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Perspektif');

$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
$objWriter->save(str_replace('.php', '.xlsx', __FILE__));

header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: attachment; filename="Master Perspektif.xlsx"');
