...
// print_r($where);
// die();
$sql = "SELECT a.* from satuan_master a
where a.last_update is not null
order by a.id_satuan asc";
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A4', 'Master Satuan')
            ->setCellValue('A5', 'No')
            ->setCellValue('B5', 'Kode Satuan')
            ->setCellValue('C5', 'Nama Satuan')
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master Satuan');

$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
$objWriter->save(str_replace('.php', '.xlsx', __FILE__));

header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: attachment; filename="Master Satuan.xlsx"');
