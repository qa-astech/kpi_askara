...
// print_r($where);
// die();
$sql = "SELECT a.* from plant_master a
...
$objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue('A4', 'Master Plant')
            ->setCellValue('A5', 'No')
            ->setCellValue('B5', 'Kode Plant')
            ->setCellValue('C5', 'Nama Plant')
...
// Rename worksheet
$objPHPExcel->getActiveSheet()->setTitle('Master plant');

$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
$objWriter->save(str_replace('.php', '.xlsx', __FILE__));

header('Content-type: application/vnd.ms-excel');
header('Content-Disposition: attachment; filename="Master plant.xlsx"');
